...
class StoreMenuItemRequest extends FormRequest
{
    ...
    public function toDto(): CreateMenuItemData
    {
        ...
        return new CreateMenuItemData(
            ...
            is_sold_out: $validated['is_sold_out'] ?? false,
            available_from: $validated['available_from'] ?? null,
            available_until: $validated['available_until'] ?? null,
            available_days: $validated['available_days'] ?? 127,
            sort_order: $validated['sort_order'] ?? null,
            option_group_ids: $validated['option_group_ids'] ?? [],
            allergens: $validated['allergens'] ?? 0,
            allergen_advisories: $validated['allergen_advisories'] ?? 0,
